...
Привет 👋  
Frontend-разработчик с 2+ годами коммерческого опыта в продуктовой разработке.
Ключевая специализация — работа с mxGraph: разработка и поддержка сложных графовых интерфейсов, схем и редакторов, кастомизация логики, событий и поведения элементов.
